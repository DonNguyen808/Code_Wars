...
/* 
a list of integers that will at least have one element
returns the multiples of their position in a list form
[1, 2, 3] => [2]
use the modulus to check through the filter method
*/

// function multipleOfIndex(array) {
//     return array.filter((el, indx) => {
//         return el % indx == 0
//     })
// }

let multipleOfIndex = arr => arr.filter((el, indx) => el % indx == 0)
